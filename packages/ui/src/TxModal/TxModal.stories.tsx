...
const meta = {
    ...
    docs: {
      description: {
        component: [
          ...
          "```",
          "",
          "**닫는 길은 셋, 콜백은 하나다.** 셋 다 `onClose` 로 온다.",
          "",
          "| 닫는 길 | 기본 | 끄는 법 |",
          "| --- | --- | --- |",
          "| 닫기 버튼(X) | 있다 | `hideCloseButton` |",
          "| 바깥(어두운 바탕) 클릭 | 닫힌다 | `closeOnBackdrop={false}` |",
          "| Escape | 닫힌다 | `closeOnEscape={false}` |",
          "",
          "**셋을 다 끄지는 말 것** — 닫을 길이 없어진다. 답을 받아야 하는 창이라면 안에",
          "확인·취소 버튼을 두고 그 버튼이 닫는다 (`TxDialog` 가 그렇게 한다).",
  ...
  argTypes: {
    ...
    closeOnEscape: { control: "boolean", description: "Escape 로 닫는다. 끄면 아무 일도 안 한다" },
