    ...
    docs: {
      description: {
        component: [
          ...
          "",
          "### `TxCollapsible` 과 무엇이 다른가",
          "",
          "둘 다 접힌다. **접는 것이 목적이면 `TxCollapsible` 을 쓴다.**",
          "",
          "| | `TxCard` | `TxCollapsible` |",
          "| --- | --- | --- |",
          "| 본업 | **상자** — 그림자 · `Footer` 슬롯 | **접기** |",
          "| 접힌 글을 ⌘F 로 찾기 | 안 된다 | **된다** |",
          "| 제목 줄에 다른 버튼 놓기 | 쉽다 | 누르면 접혀 버린다 |",
          "",
          "그래서 **FAQ · 약관처럼 글이 접히는 자리**는 `TxCollapsible` 이다 — 접힌 글이 검색에",
          "안 걸리면 없는 글이나 마찬가지다. **제목 줄에 새로고침 · 더보기 같은 동작이 여럿 붙는**",
          "패널은 이쪽이다. 그 줄은 평범한 요소라 무엇을 놓아도 접기와 부딪히지 않는다.",
          "",
