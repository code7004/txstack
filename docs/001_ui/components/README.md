...
| 문서                      | S1 상태                                                                                               |
| ------------------------- | ----------------------------------------------------------------------------------------------------- |
| [TxSpinner](TxSpinner.md) | **✅ S1~S4 + 🧑 확인 + S6 (2026-08-25)** — 판정 **수정**. S5 만 ⏸(`903` 미정). **작성 양식의 본보기** |
| [TxButton](TxButton.md)   | **✅ S1~S4 (2026-08-25) · 🧑 확인 대기** — 판정 **수정**. **커스터마이징 3단 방침이 여기서 나왔다**   |
| 그 외 24종                | 스켈레톤 (인벤토리만 채워짐)                                                                          |
