...
> 상태: **2차 `S1`~`S4` + 🧑 확인까지 끝났다 (2026-08-26).** 상세는 §14~§20. 남은 것은 `S5`(보류) · `S6`.
...
- **`packages/ui/README.md` · `AGENTS.md`** — `TxThemeProvider` 와 `@source` 안내가 아직 살아 있다.
  **`@layer` 한 줄 안내가 여기 들어가야 한다** (`001-TxButton-S6` · `001-TxSpinner-S6`)
