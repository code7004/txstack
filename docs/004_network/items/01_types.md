...
| 단계 | 내용                                            | job ID         | 상태 | 비고                                              |
| ---- | ----------------------------------------------- | -------------- | ---- | ------------------------------------------------- |
| `S1` | 문서 = 명세 + 현행 코드 감사 🤝                 | `004-types-S1` |      |                                                   |
| `S2` | 구현 = 감사 결과 반영 🧑/🤖                     | `004-types-S2` |      |                                                   |
| `S3` | 테스트 🤖                                       | `004-types-S3` |      |                                                   |
| `S4` | 스토리북                                        | —              | —    | `ui` 패키지가 아니므로 해당 없음                  |
| 🧑   | **사용자 확인** — playground·예제로 직접 써본다 | —              | —    | 통과하면 S5 로. 고칠 게 나오면 S2~S3 을 다시 돈다 |
| `S5` | 문서 사이트 (예제·코드) 🤖                      | `004-types-S5` |      |                                                   |
| `S6` | Claude 가이드 🤖                                | `004-types-S6` |      |                                                   |

## 1. 현재 코드 인벤토리 (2026-08-25)

| 항목      | 값                                                                                  |
| --------- | ----------------------------------------------------------------------------------- |
| 위치      | `packages/network/src/types.ts`                                                     |
| 코드 행수 | 88행                                                                                |
| export    | `IApiResponse` · `IApiError` · `DeleteOptions` · `HttpClientOptions` · `HttpClient` |
