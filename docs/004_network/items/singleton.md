...
| 단계 | 내용                            | job ID             | 상태 | 비고                             |
| ---- | ------------------------------- | ------------------ | ---- | -------------------------------- |
| `S1` | 문서 = 명세 + 현행 코드 감사 🤝 | `004-singleton-S1` |      |                                  |
| `S2` | 구현 = 감사 결과 반영 🧑/🤖     | `004-singleton-S2` |      |                                  |
| `S3` | 테스트 🤖                       | `004-singleton-S3` |      |                                  |
| `S4` | 스토리북                        | —                  | —    | `ui` 패키지가 아니므로 해당 없음 |
| `S5` | 문서 사이트 (예제·코드) 🤖      | `004-singleton-S5` |      |                                  |
| `S6` | Claude 가이드 🤖                | `004-singleton-S6` |      |                                  |

## 1. 현재 코드 인벤토리 (2026-08-25)

| 항목      | 값                                                                                                               |
| --------- | ---------------------------------------------------------------------------------------------------------------- |
| 위치      | `packages/network/src/singleton.ts`                                                                              |
| 코드 행수 | 49행                                                                                                             |
| export    | `initHttpClient` · `getHttpClient` · `resetHttpClient` · `getAxios` · `changeAxiosConfig` · `changeAxiosBaseUrl` |

### 착수 전에 알아야 할 것

- 전역 인스턴스. **필요성부터 판단한다** — singleton 은 테스트를 어렵게 만든다
- export 6개. `createHttpClient` 와 역할이 겹친다
