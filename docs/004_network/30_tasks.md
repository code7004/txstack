...
| ---- | ------------------------------------------------- | --- | --- | --- | --- | --- | ----- | --------------------------------------------------------- |
| 1    | [types](items/types.md)                           |     |     |     |     |     | 88행  | **`IApiResponse` 봉투를 패키지가 정해도 되나**            |
| 2    | [createHttpClient](items/createHttpClient.md)     |     |     |     |     |     | 86행  | "초기화를 쉽게" 의 실체. 테스트 이미 있음                 |
| 3    | [attachInterceptors](items/attachInterceptors.md) |     |     |     |     |     | 104행 | **"로그" 의 실체.** 인증·401 은 정책 — 주입으로 뺄 것인가 |
| 4    | [utils](items/utils.md)                           |     |     |     |     |     | 67행  | `isTokenExpired` — 인증 정책 누출                         |
| 5    | [singleton](items/singleton.md)                   |     |     |     |     |     | 49행  | **필요성부터.** 테스트를 어렵게 만든다                    |
