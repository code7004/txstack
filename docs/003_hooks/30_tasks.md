...
```
docs/README.md 와 docs/003_hooks/items/useUrlQuery.md 를 읽고 003-useUrlQuery-S1 부터 진행해줘.
```
...
| ---- | ----------------------------------------------- | --- | --- | --- | --- | --- | ----- | -------------------------------------------- |
| 1    | [useObjectChanged](items/useObjectChanged.md)   |     |     |     |     |     | 66행  | **존치 판정** — 요청 범위 밖                 |
| 2    | [useSafePolling](items/useSafePolling.md)       |     |     |     |     |     | 51행  | **존치 판정** — 정책성이 강함                |
| 3    | [useStateForObject](items/useStateForObject.md) |     |     |     |     |     | 65행  | **존치 판정** — `any` 사용                   |
| 4    | [useUrlQuery](items/useUrlQuery.md)             |     |     |     |     |     | 268행 | **이 패키지의 핵심.** 옵션 7개가 다 필요한가 |
